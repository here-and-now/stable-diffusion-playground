...
parser.add_argument("--outdir", type=str, nargs="?", help="dir to write results to", default="/home/os/gits/stable-diffusion/outputs/txt2img-samples")
parser.add_argument(
    "--skip_grid",
    action="store_true",
...
# Logging
logger(vars(opt), log_csv = "/home/os/gits/stable-diffusion/logs/txt2img_logs.csv")
